"""
Classe base para telas de formulário modais
"""
...
class BaseFormScreen:
    """Classe base para formulários modais"""
    
    def __init__(self, parent, user_manager, title, subtitle="", on_success=None, on_cancel=None):
        """Inicializa o formulário modal"""
        self.parent = parent
        ...
        self.window.transient(parent)  # Torna a janela modal em relação ao pai
    ...
    def setup_base_ui(self):
        ...
        try:
            ...
            # Limitar o tamanho máximo à área útil da tela
            max_width = self.window.winfo_screenwidth() - 100
            max_height = self.window.winfo_screenheight() - 100
            width = min(self.window.winfo_width() + 40, max_width)
            height = min(self.window.winfo_height() + 40, max_height)
    ...
    def create_form_fields(self):
        """Cria os campos do formulário - deve ser implementado pelas subclasses"""
        pass
    
    def load_defaults(self):
        """Carrega valores padrão - pode ser implementado pelas subclasses"""
        pass
