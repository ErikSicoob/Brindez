"""
Script para corrigir problemas de layout na tela de cadastro de brindes.
"""

def fix_cadastro_brindes():
    """Corrige o layout da tela de cadastro de brindes."""
    content = """"""
"""
...
class CadastroBrindesScreen(BaseScreen):
    ...
    def __init__(self, parent, user_manager, on_success=None):
        ...
        super().__init__(parent, user_manager, "Cadastro de Brindes")
    ...
    def setup_ui(self):
        ...
        # Título
        self.create_title("➕ Cadastro de Novo Brinde", "Preencha os dados do brinde")
    ...
    def _safe_get_filial_names(self):
        ...
        try:
            ...
            return ["Matriz"]
"""
    with open("c:\\Pojetos - DEV\\Brindez\\src\\ui\\screens\\cadastro_brindes.py", "w", encoding="utf-8") as f:
        f.write(content)

if __name__ == "__main__":
    fix_cadastro_brindes()
